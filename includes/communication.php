...
class Communication extends Dynadot
{
    private $service;
    private $client;
    private $company;
    ...
    {
        return Configure::get('Dynadot.notices');
    }
    ...
    public function send(array $post)
    {
        ...
        $result = $this->Emails->sendCustom(
            ...
            $from_name,
            $this->client->email,
            Language::_('Dynadot.notices.' . $notice . '.subject', true),
            ['text' => Language::_('Dynadot.notices.' . $notice . '.text', true)],
            $tags,
            null,
            $from
        );
